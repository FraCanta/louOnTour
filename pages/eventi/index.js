        ...
        <section className="w-11/12 px-4 py-10 mx-auto lg:px-10 lg:py-16">
          <div className="grid items-end grid-cols-1 gap-8 lg:grid-cols-[1.15fr_0.85fr]">
            <div className="flex flex-col gap-4">
              <p className="text-sm lg:text-base font-semibold px-3 lg:px-4 py-2 bg-[#CE9486]/20 rounded-full max-w-max tracking-wide">
                {copy.page.eyebrow}
              </p>

              <MaskText>
                <h1 className="text-[2.5rem] md:text-[3.8rem] xl:text-[5rem] font-bold leading-none max-w-5xl text-principle">
                  {copy.page.heading}
                </h1>
              </MaskText>
              ...
              <div className="relative h-[320px]">
                ...
                <div className="absolute inset-x-0 bottom-0 p-6">
                  <span className="inline-flex items-center gap-2 rounded-full bg-[#fef3ea]/90 px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-[#c9573c]">
                    <Icon icon="hugeicons:calendar-03" width="14" height="14" />
                    {copy.page.featured}
                  </span>
