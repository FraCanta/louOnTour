  ...
  return (
    <div className="hero_container leading-none w-full">
      <section className="text-center h-[calc(100vh_-_98px)] flex flex-col items-center justify-center hero">
        <h2 className="text-[2rem] 2xl:text-[2.5rem] fxl:text-[4rem] font-medium text-[#D93280] mb-4 mt-10">
          Tuscan Experience
        </h2>
        <h1 className="text-[4.8rem] 2xl:text-[12rem] fxl:text-[15.625rem] font-bold tracking-[-0.020em] text-white mb-8 mt-5">
          Lou On Tour
        </h1>
