...
const HeroCities = ({ city }) => {
  ...
  return (
    <>
      <div
        className={`container mx-auto w-full xl:w-4/5 ${expand.background} rounded-none xl:rounded-xl text-5xl mb-10 text-white relative cursor-pointer overflow-hidden`}
